...
var BaseRadio = require("./base-radio");
var Changeable = require("../../mixins/changeable");
var Editor = require("../../editor-stub");
var {iconPlus, iconTrash} = require("../../icon-paths.js");
var InlineIcon   = require("../../components/inline-icon");
var PropCheckBox = require("../../components/prop-check-box");
