...
// NOTE(aria): Modified to avoid globals by @ariabuckles
// NOTE(aria): we disable linting cause this file has been in use forever and
// has autogenerated parts:
/* eslint-disable */
...
parse: function parse(input) {
    ...
    //_token_stack: // NOTE(aria): causes errors in strict mode
        function lex() {
            var token;
            token = lexer.lex() || EOF;
